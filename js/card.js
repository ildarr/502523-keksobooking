...
(function () {
  window.card = {
    ...
    getMapCard: function (array, indexNumber) {
      ...
      mapCard.querySelector('h4').textContent = window.data.getOfferType(array.offer.type);
      ...
      mapCard.querySelector('.popup__features').innerHTML = window.data.getFeatures(array.offer.features);
